...
if(isset($_POST['submit'])){
    ...
    mysqli_query("insert into contact_us(name,email,mobile,comment) values ('$name','$email','$mobile','$comment')");
    $msg="Thank you";
                            ...
                            <form id="contact-form" action="<?php $_SERVER['PHP_SELF'];?>" method="post">
                                <div class="single-contact-form">
                                    <div class="contact-box name">
                                        <input type="text" id="name" name="name" placeholder="Your Name*" tabindex="1" value="<?php echo $name ?>">
                                        <br>
                                        <span class="error"><?php echo $name_error; ?></span>
                                        <input type="email" id="email" name="email" placeholder="Email*" tabindex="2" value="<?php echo $email ?>">
                                        <span class="error"><?php echo $email_error; ?></span>
                                        <input type="text" id="mobile" name="mobile" placeholder="Mobile*" tabindex="3" value="<?php echo $mobile?>">
                                        <span class="error"><?php echo $mobile_error; ?></span>
                                    </div>
                                </div>
                                <div class="single-contact-form">
                                    <div class="contact-box message">
                                        <textarea name="comment" id="comment" placeholder="Your Comment" tabindex="4" value="<?php echo $comment ?>"></textarea>
